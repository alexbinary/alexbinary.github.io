---
layout: post
title:  Utiliser SQLite sur iOS (partie 1)
date:   2019-02-21 18:19:56 +0100
categories: ios
---

SQLite est un système de gestion de bases de données intégré dans iOS et utilisable directement dans les applications en swift.

Dans cette première partie nous allons voir les bases pour gérer une base de données dans une app iOS.
Dans une seconde partie nous verrons comment construire une surcouche sur l'API C en swift.
...
La fonction `sqlite3_errmsg()` renvoit le dernier message d'erreur généré par SQLite sur la connexion.
La fonction prend un paramètre un pointeur vers la connexion (initialisé avec `sqlite3_open()`).
...
La fonction `sqlite3_close()` ferme la connexion.
La fonction prend en paramètre un pointeur vers la connexion (initialisé avec `sqlite3_open()`).
...
`sqlite3_column_int()` permet de lire un nombre, voir [ici pour la liste complète des fonctions disponibles](https://sqlite.org/c3ref/column_blob.html).
...
il faut définir les paramètres avant d'exécuter la requête avec `sqlite3_bind_text()`, `sqlite3_bind_int()`, ou `sqlite3_bind_null()` ([liste complète](https://sqlite.org/c3ref/bind_blob.html)):
...
- [https://sqlite.org/c3ref/open.html](https://sqlite.org/c3ref/open.html)
- [http://www.sqlite.org/c3ref/errcode.html](http://www.sqlite.org/c3ref/errcode.html)
- [https://sqlite.org/c3ref/close.html](https://sqlite.org/c3ref/close.html)
- [https://sqlite.org/c3ref/prepare.html](https://sqlite.org/c3ref/prepare.html)
- [https://sqlite.org/c3ref/finalize.html](https://sqlite.org/c3ref/finalize.html)
- [https://sqlite.org/c3ref/step.html](https://sqlite.org/c3ref/step.html)
- [https://sqlite.org/c3ref/column_blob.html](https://sqlite.org/c3ref/column_blob.html)
- [https://sqlite.org/c3ref/bind_blob.html](https://sqlite.org/c3ref/bind_blob.html)

Tutoriel :

- [https://www.raywenderlich.com/385-sqlite-with-swift-tutorial-getting-started](https://www.raywenderlich.com/385-sqlite-with-swift-tutorial-getting-started)
